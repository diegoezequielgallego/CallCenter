package com.almundo.examen.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.almundo.examen.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.almundo.examen.model" });
